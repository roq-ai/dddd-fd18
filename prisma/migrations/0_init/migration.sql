...
-- AddForeignKey
ALTER TABLE "time_tracking" ADD CONSTRAINT "time_tracking_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "employee"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
